package com.ynet.finmall.file.model;

import java.io.Serializable;
import java.util.Date;

public class EsWorkflowCheck implements Serializable {
    /**
     * 审核记录表ID
     */
    ...
    public void setNextAuditorId(String nextAuditorId) {
        this.nextAuditorId = nextAuditorId == null ? null : nextAuditorId.trim();
    }
    ...
    public String toString() {
        ...
        sb.append(", sonProjectId=").append(sonProjectId);
        ...
        sb.append(", nextStepCode=").append(nextStepCode);
        sb.append(", auditor=").append(auditor);
        sb.append(", nextAuditor=").append(nextAuditor);
        sb.append(", nextAuditorId=").append(nextAuditorId);

 ...
 */
public class JxInqGrantRequest {
	...
	public String getServerCode() {
		return "api/v1/loan/inq_grant_ylb.do";
	}

	@Override
	public String toString() {
		return "JxInqGrantRequest [pro_id=" + pro_id + ", comerchant_receipt_no=" + comerchant_receipt_no + ", customer=" + customer + ", apply_id=" + apply_id + ", receipt_id=" + receipt_id + ", trans_date=" + trans_date + ", trans_tradetime=" + trans_tradetime + "]";
	}
